...
def gameLoop(lives, score):
    ...
    # Variables
    bullet_count = 100000000000000000
    ...
    for x in range (number_of_ships):
        my_invader = invader(YELLOW, 30, 30, 4, random.randrange(0, 600), random.randrange(-50, 0)) # invaderships are white with size 10 by 10 px
